...
;( function( $, window, document, undefined ) {
    ...
    $.extend( Plugin.prototype, {
        ...
        widget_html: function() {
            ...
            '                            <button id="searchTickets" type="submit">'+_this.settings.localization.avia_submit_button_text+'</button>'+
            '                        </li>'+
            '                    </ul>'+
            '                </form>'+
            ...
            '                        <!-- submit button -->'+
            '                        <li class="twidget-submit-button">'+
            '                            <button id="searchHotel" type="submit">' + _this.settings.localization.hotel_submit_button_text + '</button>'+
            '                        </li>'+
            '                    </ul>'+
            '                </form>'+
            '                <div class="twidget-tab-bottom">'+
